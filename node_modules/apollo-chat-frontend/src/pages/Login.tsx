...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-200 via-blue-100 to-blue-400">
      <motion.div
      ...
      >
        ...
        <h2 className="text-3xl font-extrabold text-blue-900 mb-1">Welcome to Apollo Chat</h2>
        <p className="text-gray-500 text-base mb-2">Sign in to your account</p>
